...
// string s, t;
 ...
 // find opeartion use to get the indices of the particular charcater of the string and check if a character lies between some two characters and check parity bit
void solve() {
